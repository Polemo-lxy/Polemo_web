...
import * as Plugin_1 from 'D:/graduation/graduationWebItem/main-app/src/.umi/plugin-dva/runtime.tsx';
...
import * as Plugin_4 from '@@/plugin-qiankun/masterRuntimePlugin';
  ...
  plugin.register({
    apply: Plugin_1,
    path: 'D:/graduation/graduationWebItem/main-app/src/.umi/plugin-dva/runtime.tsx',
  });
  plugin.register({
    apply: Plugin_2,
